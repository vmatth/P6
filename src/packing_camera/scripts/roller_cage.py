...
class image_converter:
    ...
    def camera_callback(self, rgb_data, depth_data):
        ...
        try:
            ...
            #Find contours
            _, contours, _= cv2.findContours(edge_image, cv2.RETR_EXTERNAL, cv2.CHAIN_APPROX_SIMPLE) #Image for contours can be opening_image or edge_image


            cv2.drawContours(rgb_overlay, contours, -1, (0,0,255),2)
